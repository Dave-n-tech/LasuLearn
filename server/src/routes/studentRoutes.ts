...
// courses
router.get("/courses/all", verifyToken([Role.STUDENT, Role.LECTURER, Role.ADMIN]), getAllCourses)
...
router.get("/lectures/:lectureId", verifyToken([Role.STUDENT]), getLectureById)
